...
export class VehicleTemperaturesUpdatePage {
    ...
    async getVehicleRegistrationInput() {
        return this.vehicleRegistrationInput.getAttribute('value');
    }
    ...
    async getChillerSensorNumberInput() {
        return this.chillerSensorNumberInput.getAttribute('value');
    }
    ...
    async getFullSensorDataInput() {
        return this.fullSensorDataInput.getAttribute('value');
    }
    ...
    async getCompressedSensorDataInput() {
        return this.compressedSensorDataInput.getAttribute('value');
    }
