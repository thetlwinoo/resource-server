...
describe('BusinessEntityAddress e2e test', () => {
    ...
    it('should load BusinessEntityAddresses', async () => {
        ...
        expect(await businessEntityAddressComponentsPage.getTitle()).to.eq('resourceApp.businessEntityAddress.home.title');
    });
    ...
    it('should load create BusinessEntityAddress page', async () => {
        ...
        expect(await businessEntityAddressUpdatePage.getPageTitle()).to.eq('resourceApp.businessEntityAddress.home.createOrEditLabel');
    ...
    it('should create and save BusinessEntityAddresses', async () => {
        ...
        expect(await businessEntityAddressUpdatePage.getSaveButton().isPresent()).to.be.false;

        expect(await businessEntityAddressComponentsPage.countDeleteButtons()).to.eq(nbButtonsBeforeCreate + 1);
    });
    ...
    it('should delete last BusinessEntityAddress', async () => {
        ...
        expect(await businessEntityAddressDeleteDialog.getDialogTitle()).to.eq('resourceApp.businessEntityAddress.delete.question');
