...
export class ProductSetDetailsUpdatePage {
    ...
    async getSubGroupNoInput() {
        return this.subGroupNoInput.getAttribute('value');
    }
    ...
    async getSubGroupMinCountInput() {
        return this.subGroupMinCountInput.getAttribute('value');
    }
    ...
    async getSubGroupMinTotalInput() {
        return this.subGroupMinTotalInput.getAttribute('value');
    }
    ...
    async getMinCountInput() {
        return this.minCountInput.getAttribute('value');
    }
    ...
    async getMaxCountInput() {
        return this.maxCountInput.getAttribute('value');
    }
