...
describe('Service Tests', () => {
    describe('PackageTypes Service', () => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a PackageTypes', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 0,
                        validFrom: currentDate.format(DATE_FORMAT),
            ...
            it('should update a PackageTypes', async () => {
                const returnedFromService = Object.assign(
                    {
            ...
            it('should return a list of PackageTypes', async () => {
                const returnedFromService = Object.assign(
                    {
                        packageTypeName: 'BBBBBB',
                        validFrom: currentDate.format(DATE_FORMAT),
            ...
            it('should delete a PackageTypes', async () => {
