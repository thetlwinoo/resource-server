...
describe('Service Tests', () => {
    describe('BarcodeTypes Service', () => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a BarcodeTypes', async () => {
            ...
            it('should update a BarcodeTypes', async () => {
                const returnedFromService = Object.assign(
                    {
            ...
            it('should return a list of BarcodeTypes', async () => {
                const returnedFromService = Object.assign(
                    {
                        barcodeTypeName: 'BBBBBB'
                    },
            ...
            it('should delete a BarcodeTypes', async () => {
