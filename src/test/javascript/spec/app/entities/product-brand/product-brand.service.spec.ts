...
describe('Service Tests', () => {
    describe('ProductBrand Service', () => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a ProductBrand', async () => {
            ...
            it('should update a ProductBrand', async () => {
                const returnedFromService = Object.assign(
                    {
            ...
            it('should return a list of ProductBrand', async () => {
                const returnedFromService = Object.assign(
                    {
                        productBrandName: 'BBBBBB',
                        photo: 'BBBBBB'
            ...
            it('should delete a ProductBrand', async () => {
