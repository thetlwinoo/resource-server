...
describe('Service Tests', () => {
    describe('PersonPhone Service', () => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a PersonPhone', async () => {
            ...
            it('should update a PersonPhone', async () => {
                const returnedFromService = Object.assign(
                    {
                        phoneNumber: 'BBBBBB',
                        defaultInd: true,
            ...
            it('should return a list of PersonPhone', async () => {
                const returnedFromService = Object.assign(
                    {
                        phoneNumber: 'BBBBBB',
                        defaultInd: true,
            ...
            it('should delete a PersonPhone', async () => {
