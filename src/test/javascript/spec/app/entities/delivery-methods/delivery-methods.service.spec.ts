...
describe('Service Tests', () => {
    describe('DeliveryMethods Service', () => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a DeliveryMethods', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 0,
                        validFrom: currentDate.format(DATE_FORMAT),
            ...
            it('should update a DeliveryMethods', async () => {
                const returnedFromService = Object.assign(
                    {
            ...
            it('should return a list of DeliveryMethods', async () => {
                const returnedFromService = Object.assign(
                    {
                        deliveryMethodName: 'BBBBBB',
                        validFrom: currentDate.format(DATE_FORMAT),
            ...
            it('should delete a DeliveryMethods', async () => {
