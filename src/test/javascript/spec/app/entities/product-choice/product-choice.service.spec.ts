...
describe('Service Tests', () => {
    describe('ProductChoice Service', () => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a ProductChoice', async () => {
            ...
            it('should update a ProductChoice', async () => {
                const returnedFromService = Object.assign(
                    {
                        isMultiply: true
                    },
            ...
            it('should return a list of ProductChoice', async () => {
                const returnedFromService = Object.assign(
                    {
                        isMultiply: true
                    },
            ...
            it('should delete a ProductChoice', async () => {
