...
describe('Service Tests', () => {
    describe('ReviewLines Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new ReviewLines(0, 0, 'AAAAAAA', 0, 'AAAAAAA', 0, 'AAAAAAA', 'image/png', 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a ReviewLines', async () => {
            ...
            it('should update a ReviewLines', async () => {
                const returnedFromService = Object.assign(
                    {
                        productRating: 1,
            ...
            it('should return a list of ReviewLines', async () => {
                const returnedFromService = Object.assign(
                    {
                        productRating: 1,
                        productReview: 'BBBBBB',
            ...
            it('should delete a ReviewLines', async () => {
