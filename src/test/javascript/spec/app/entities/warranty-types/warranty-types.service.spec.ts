...
describe('Service Tests', () => {
    describe('WarrantyTypes Service', () => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a WarrantyTypes', async () => {
            ...
            it('should update a WarrantyTypes', async () => {
                const returnedFromService = Object.assign(
                    {
            ...
            it('should return a list of WarrantyTypes', async () => {
                const returnedFromService = Object.assign(
                    {
                        warrantyTypeName: 'BBBBBB'
                    },
            ...
            it('should delete a WarrantyTypes', async () => {
