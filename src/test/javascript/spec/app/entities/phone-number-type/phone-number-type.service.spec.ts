...
describe('Service Tests', () => {
    describe('PhoneNumberType Service', () => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a PhoneNumberType', async () => {
            ...
            it('should update a PhoneNumberType', async () => {
                const returnedFromService = Object.assign(
                    {
            ...
            it('should return a list of PhoneNumberType', async () => {
                const returnedFromService = Object.assign(
                    {
                        phoneNumberTypeName: 'BBBBBB'
                    },
            ...
            it('should delete a PhoneNumberType', async () => {
