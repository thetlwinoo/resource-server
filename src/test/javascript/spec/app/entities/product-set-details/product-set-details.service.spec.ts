...
describe('Service Tests', () => {
    describe('ProductSetDetails Service', () => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a ProductSetDetails', async () => {
                ...
                service
                    .create(new ProductSetDetails(null))
                    .pipe(take(1))
            ...
            it('should update a ProductSetDetails', async () => {
                const returnedFromService = Object.assign(
                    {
                        subGroupNo: 1,
                        subGroupMinCount: 1,
            ...
            it('should return a list of ProductSetDetails', async () => {
                const returnedFromService = Object.assign(
                    {
                        subGroupNo: 1,
                        subGroupMinCount: 1,
            ...
            it('should delete a ProductSetDetails', async () => {
