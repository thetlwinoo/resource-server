...
describe('Service Tests', () => {
    describe('ProductModel Service', () => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a ProductModel', async () => {
            ...
            it('should update a ProductModel', async () => {
                const returnedFromService = Object.assign(
                    {
            ...
            it('should return a list of ProductModel', async () => {
                const returnedFromService = Object.assign(
                    {
                        productModelName: 'BBBBBB',
                        calalogDescription: 'BBBBBB',
            ...
            it('should delete a ProductModel', async () => {
