...
describe('Service Tests', () => {
    describe('ShoppingCartItems Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new ShoppingCartItems(0, 0);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a ShoppingCartItems', async () => {
            ...
            it('should update a ShoppingCartItems', async () => {
                const returnedFromService = Object.assign(
                    {
                        quantity: 1
                    },
            ...
            it('should return a list of ShoppingCartItems', async () => {
                const returnedFromService = Object.assign(
                    {
                        quantity: 1
                    },
            ...
            it('should delete a ShoppingCartItems', async () => {
