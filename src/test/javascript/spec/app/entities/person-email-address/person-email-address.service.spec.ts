...
describe('Service Tests', () => {
    describe('PersonEmailAddress Service', () => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a PersonEmailAddress', async () => {
                ...
                service
                    .create(new PersonEmailAddress(null))
                    .pipe(take(1))
            ...
            it('should update a PersonEmailAddress', async () => {
                const returnedFromService = Object.assign(
                    {
                        emailAddress: 'BBBBBB',
                        defaultInd: true,
            ...
            it('should return a list of PersonEmailAddress', async () => {
                const returnedFromService = Object.assign(
                    {
                        emailAddress: 'BBBBBB',
                        defaultInd: true,
            ...
            it('should delete a PersonEmailAddress', async () => {
