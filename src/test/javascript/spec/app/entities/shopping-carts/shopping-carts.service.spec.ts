...
describe('Service Tests', () => {
    describe('ShoppingCarts Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new ShoppingCarts(0, 0, 0);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a ShoppingCarts', async () => {
            ...
            it('should update a ShoppingCarts', async () => {
                const returnedFromService = Object.assign(
                    {
                        totalPrice: 1,
                        totalCargoPrice: 1
            ...
            it('should return a list of ShoppingCarts', async () => {
                const returnedFromService = Object.assign(
                    {
                        totalPrice: 1,
                        totalCargoPrice: 1
            ...
            it('should delete a ShoppingCarts', async () => {
