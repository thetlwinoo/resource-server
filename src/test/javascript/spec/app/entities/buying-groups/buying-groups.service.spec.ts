...
describe('Service Tests', () => {
    describe('BuyingGroups Service', () => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a BuyingGroups', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 0,
                        validFrom: currentDate.format(DATE_FORMAT),
            ...
            it('should update a BuyingGroups', async () => {
                const returnedFromService = Object.assign(
                    {
            ...
            it('should return a list of BuyingGroups', async () => {
                const returnedFromService = Object.assign(
                    {
                        buyingGroupName: 'BBBBBB',
                        validFrom: currentDate.format(DATE_FORMAT),
            ...
            it('should delete a BuyingGroups', async () => {
