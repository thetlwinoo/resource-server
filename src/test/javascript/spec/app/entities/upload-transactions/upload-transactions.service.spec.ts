...
describe('Service Tests', () => {
    describe('UploadTransactions Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new UploadTransactions(0, 'AAAAAAA', 'AAAAAAA', 0, 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a UploadTransactions', async () => {
            ...
            it('should update a UploadTransactions', async () => {
                const returnedFromService = Object.assign(
                    {
                        fileName: 'BBBBBB',
                        templateUrl: 'BBBBBB',
            ...
            it('should return a list of UploadTransactions', async () => {
                const returnedFromService = Object.assign(
                    {
                        fileName: 'BBBBBB',
                        templateUrl: 'BBBBBB',
            ...
            it('should delete a UploadTransactions', async () => {
