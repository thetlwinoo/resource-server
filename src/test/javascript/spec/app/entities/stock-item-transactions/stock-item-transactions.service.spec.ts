...
describe('Service Tests', () => {
    describe('StockItemTransactions Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new StockItemTransactions(0, currentDate, 0);
        });
        ...
        describe('Service methods', async () => {
            it('should find an element', async () => {
                const returnedFromService = Object.assign(
                    {
                        transactionOccurredWhen: currentDate.format(DATE_FORMAT)
                    },
                    elemDefault
                );
                service
            ...
            it('should create a StockItemTransactions', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 0,
                        transactionOccurredWhen: currentDate.format(DATE_FORMAT)
            ...
            it('should update a StockItemTransactions', async () => {
                const returnedFromService = Object.assign(
                    {
                        transactionOccurredWhen: currentDate.format(DATE_FORMAT),
                        quantity: 1
            ...
            it('should return a list of StockItemTransactions', async () => {
                const returnedFromService = Object.assign(
                    {
                        transactionOccurredWhen: currentDate.format(DATE_FORMAT),
                        quantity: 1
            ...
            it('should delete a StockItemTransactions', async () => {
