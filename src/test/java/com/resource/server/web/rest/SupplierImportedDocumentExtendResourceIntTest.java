...
import com.resource.server.service.SupplierImportedDocumentExtendService;
...
public class SupplierImportedDocumentExtendResourceIntTest {

    private MockMvc restMockMvc;
    private final SupplierImportedDocumentExtendService supplierImportedDocumentExtendService;

    public SupplierImportedDocumentExtendResourceIntTest(SupplierImportedDocumentExtendService supplierImportedDocumentExtendService) {
