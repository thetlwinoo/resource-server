...
import com.resource.server.config.audit.AuditEventConverter;
import com.resource.server.domain.PersistentAuditEvent;
...
import static com.resource.server.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
