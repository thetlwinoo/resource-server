...
public class MaterialsResource {
    ...
    /**
     * POST  /materials : Create a new materials.
     *
     * @param materialsDTO the materialsDTO to create
     * @return the ResponseEntity with status 201 (Created) and with body the new materialsDTO, or with status 400 (Bad Request) if the materials has already an ID
    ...
    /**
     * PUT  /materials : Updates an existing materials.
     *
     * @param materialsDTO the materialsDTO to update
     * @return the ResponseEntity with status 200 (OK) and with body the updated materialsDTO,
     * or with status 400 (Bad Request) if the materialsDTO is not valid,
     * or with status 500 (Internal Server Error) if the materialsDTO couldn't be updated
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    ...
    public ResponseEntity<MaterialsDTO> updateMaterials(@Valid @RequestBody MaterialsDTO materialsDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(ENTITY_NAME, materialsDTO.getId().toString()))
            .body(result);
    }
    ...
    */
    ...
    /**
     * GET  /materials/:id : get the "id" materials.
     *
     * @param id the id of the materialsDTO to retrieve
     * @return the ResponseEntity with status 200 (OK) and with body the materialsDTO, or with status 404 (Not Found)
     */
    ...
    /**
     * DELETE  /materials/:id : delete the "id" materials.
     *
