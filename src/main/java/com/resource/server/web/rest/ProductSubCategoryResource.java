...
public class ProductSubCategoryResource {
    ...
    public ResponseEntity<List<ProductSubCategoryDTO>> getAllProductSubCategories(ProductSubCategoryCriteria criteria) {
        log.debug("REST request to get ProductSubCategories by criteria: {}", criteria);
        List<ProductSubCategoryDTO> entityList = productSubCategoryQueryService.findByCriteria(criteria);
