...
public class StripeClientServiceImpl implements StripeClientService {
    ...
    @Autowired
    StripeClientServiceImpl(PaymentTransactionsRepository paymentTransactionsRepository, PaymentTransactionsService paymentTransactionsService, OrdersRepository ordersRepository) {
        ...
        Stripe.apiKey = "sk_test_VweO8sXMgLDpvzE0CJbBHGcN00UJNvFoXj";
    }
