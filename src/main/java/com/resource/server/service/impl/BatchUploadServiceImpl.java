...
//                            String searchKeywords = searchKeywordsLength > 255 ? row.getCell(cell.getColumnIndex()).getStringCellValue().trim().substring(0, Math.min(searchKeywordsLength, 255)) : row.getCell(cell.getColumnIndex()).getStringCellValue().trim();
                            ...
                            stockItemTemp.setRemommendedRetailPrice(new Double(row.getCell(cell.getColumnIndex()).getNumericCellValue()).floatValue());
                        } else if (ColumnName.equalsIgnoreCase("Retail Price") && row.getCell(cell.getColumnIndex()).getCellType() == Cell.CELL_TYPE_NUMERIC) {
                            stockItemTemp.setUnitPrice(new Double(row.getCell(cell.getColumnIndex()).getNumericCellValue()).floatValue());
                            ...
                            stockItemTemp.setItemWeight(new Double(row.getCell(cell.getColumnIndex()).getNumericCellValue()).floatValue());
                            ...
                            stockItemTemp.setItemPackageWeight(new Double(row.getCell(cell.getColumnIndex()).getNumericCellValue()).floatValue());
