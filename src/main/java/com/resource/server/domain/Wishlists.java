...
public class Wishlists extends AbstractAuditingEntity implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (wishlists.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), wishlists.getId());
    }
