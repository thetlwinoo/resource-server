...
public class PersonEmailAddress extends AbstractAuditingEntity implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        PersonEmailAddress personEmailAddress = (PersonEmailAddress) o;
        if (personEmailAddress.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), personEmailAddress.getId());
    }
