...
public class StockItemTemp extends AbstractAuditingEntity implements Serializable {
    ...
    @Column(name = "remommended_retail_price")
    private Float remommendedRetailPrice;
    ...
    public StockItemTemp unitPrice(Float unitPrice) {
    ...
    public Float getRemommendedRetailPrice() {
        return remommendedRetailPrice;
    }

    public StockItemTemp remommendedRetailPrice(Float remommendedRetailPrice) {
        this.remommendedRetailPrice = remommendedRetailPrice;
        return this;
    }

    public void setRemommendedRetailPrice(Float remommendedRetailPrice) {
        this.remommendedRetailPrice = remommendedRetailPrice;
    }
    ...
    public StockItemTemp itemWeight(Float itemWeight) {
    ...
    public StockItemTemp itemPackageWeight(Float itemPackageWeight) {
    ...
    public StockItemTemp sellStartDate(LocalDate sellStartDate) {
    ...
    public StockItemTemp sellEndDate(LocalDate sellEndDate) {
    ...
    public boolean equals(Object o) {
        ...
        StockItemTemp stockItemTemp = (StockItemTemp) o;
        if (stockItemTemp.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), stockItemTemp.getId());
    }
