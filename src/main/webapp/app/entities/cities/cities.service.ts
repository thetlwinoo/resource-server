...
export class CitiesService {
    ...
    protected convertDateFromClient(cities: ICities): ICities {
        const copy: ICities = Object.assign({}, cities, {
            validFrom: cities.validFrom != null && cities.validFrom.isValid() ? cities.validFrom.format(DATE_FORMAT) : null,
            validTo: cities.validTo != null && cities.validTo.isValid() ? cities.validTo.format(DATE_FORMAT) : null
        });
        return copy;
    }
