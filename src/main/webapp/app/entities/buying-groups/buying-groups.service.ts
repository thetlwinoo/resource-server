...
export class BuyingGroupsService {
    ...
    protected convertDateFromClient(buyingGroups: IBuyingGroups): IBuyingGroups {
        const copy: IBuyingGroups = Object.assign({}, buyingGroups, {
            validFrom:
                buyingGroups.validFrom != null && buyingGroups.validFrom.isValid() ? buyingGroups.validFrom.format(DATE_FORMAT) : null,
            validTo: buyingGroups.validTo != null && buyingGroups.validTo.isValid() ? buyingGroups.validTo.format(DATE_FORMAT) : null
        });
        return copy;
    }
