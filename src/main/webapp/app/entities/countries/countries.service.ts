...
export class CountriesService {
    ...
    protected convertDateFromClient(countries: ICountries): ICountries {
        const copy: ICountries = Object.assign({}, countries, {
            validFrom: countries.validFrom != null && countries.validFrom.isValid() ? countries.validFrom.format(DATE_FORMAT) : null,
            validTo: countries.validTo != null && countries.validTo.isValid() ? countries.validTo.format(DATE_FORMAT) : null
        });
        return copy;
    }
