...
export class SpecialDealsService {
    ...
    protected convertDateFromClient(specialDeals: ISpecialDeals): ISpecialDeals {
        const copy: ISpecialDeals = Object.assign({}, specialDeals, {
            startDate:
                specialDeals.startDate != null && specialDeals.startDate.isValid() ? specialDeals.startDate.format(DATE_FORMAT) : null,
            endDate: specialDeals.endDate != null && specialDeals.endDate.isValid() ? specialDeals.endDate.format(DATE_FORMAT) : null
        });
        return copy;
    }
