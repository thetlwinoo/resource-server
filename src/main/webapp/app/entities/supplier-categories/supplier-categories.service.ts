...
export class SupplierCategoriesService {
    ...
    protected convertDateFromClient(supplierCategories: ISupplierCategories): ISupplierCategories {
        const copy: ISupplierCategories = Object.assign({}, supplierCategories, {
            validFrom:
                supplierCategories.validFrom != null && supplierCategories.validFrom.isValid()
                    ? supplierCategories.validFrom.format(DATE_FORMAT)
                    : null,
            validTo:
                supplierCategories.validTo != null && supplierCategories.validTo.isValid()
                    ? supplierCategories.validTo.format(DATE_FORMAT)
                    : null
        });
        return copy;
    }
