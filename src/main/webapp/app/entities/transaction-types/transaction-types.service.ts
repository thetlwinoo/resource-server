...
export class TransactionTypesService {
    ...
    protected convertDateFromClient(transactionTypes: ITransactionTypes): ITransactionTypes {
        const copy: ITransactionTypes = Object.assign({}, transactionTypes, {
            validFrom:
                transactionTypes.validFrom != null && transactionTypes.validFrom.isValid()
                    ? transactionTypes.validFrom.format(DATE_FORMAT)
                    : null,
            validTo:
                transactionTypes.validTo != null && transactionTypes.validTo.isValid() ? transactionTypes.validTo.format(DATE_FORMAT) : null
        });
        return copy;
    }
