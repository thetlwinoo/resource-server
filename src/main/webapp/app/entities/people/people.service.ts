...
export class PeopleService {
    ...
    protected convertDateFromClient(people: IPeople): IPeople {
        const copy: IPeople = Object.assign({}, people, {
            validFrom: people.validFrom != null && people.validFrom.isValid() ? people.validFrom.format(DATE_FORMAT) : null,
            validTo: people.validTo != null && people.validTo.isValid() ? people.validTo.format(DATE_FORMAT) : null
        });
        return copy;
    }
