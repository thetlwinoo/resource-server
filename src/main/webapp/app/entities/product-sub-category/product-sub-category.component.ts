...
export class ProductSubCategoryComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.productSubCategoryService
            ...
            .subscribe(
                (res: HttpResponse<IProductSubCategory[]>) => this.paginateProductSubCategories(res.body, res.headers),
    ...
    protected paginateProductSubCategories(data: IProductSubCategory[], headers: HttpHeaders) {
